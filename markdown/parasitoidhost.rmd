---
title: "Parasitoid-host models"
author: Ottar N. Bjornstad
output: html_document
runtime: shiny
---

This Rmarkdown of Nicholson-Bailey and negative-binomial parasitoid-host model was written by Ottar N. Bjornstad and is released with a CC-BY-NC license for anyone to improve and re-share (acknowledging origin). Please email me a copy if you make an update (onb1 at psu dot edu).
...
Nicholson and Bailey (1935) showed that the equilibrium $H^* = \frac{\mbox{log}(R)}{a (R-1)}, P^* = \frac{\mbox{log}(R)}{a}$" is an ustable focus leading to increasingly violent consumer-resource cycles.
