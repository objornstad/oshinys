...
Adults are assumed to lay $b$ eggs of which a fraction $1-e^{-c_{ea} A_t}$ cannibalized by adults and $1-e^{-c_{el}L_t}$ by larvae; $c_{ea}$ and $c_{el}$ are cannibalism coefficients. Larvae suffers density independent mortality of strengh $m_l$. The egg and the larval stages are assumed to be two weeks. A fraction $1-e^{-c_{pa} A_t}$ of the pupae are cannibalized by adults. Adults suffer density independent mortality $m_a$.

Costantino et al. (1997) used replacement experiments to increase adult mortality from the control of $m_l = 0.0076$ to $m_l = 0.96$ and manipulated pupal canibalism rates to $c_{pa}$ = 0 (stable), 0.05 (8-cycle), 0.010 (invariant loop), 0.25 (chaotic), 0.35 (chaotic), 0.5 (3-cycle or chaotic), 1 (3-cycle)$.
